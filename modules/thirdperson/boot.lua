...
if ( CLIENT ) then
    ...
    ax.localization:Register("es-ES", {
        ...
        ["options.thirdperson.follax.Head"] = "Seguir Cabeza",
        ["options.thirdperson.follax.Head.help"] = "Seguir la cabeza del jugador con la cámara en tercera persona.",
        ["options.thirdperson.follax.Hit.angles"] = "Seguir Ángulos de Impacto",
        ["options.thirdperson.follax.Hit.angles.help"] = "Seguir los ángulos de impacto con la cámara en tercera persona.",
        ["options.thirdperson.follax.Hit.fov"] = "Seguir FOV de Impacto",
        ["options.thirdperson.follax.Hit.fov.help"] = "Seguir el campo de visión (FOV) de impacto con la cámara en tercera persona.",
    ...
    ax.localization:Register("pt-PT", {
        ...
        ["options.thirdperson.follax.Head"] = "Seguir Cabeça",
        ["options.thirdperson.follax.Head.help"] = "Seguir a cabeça do jogador com a câmara em terceira pessoa.",
        ["options.thirdperson.follax.Hit.angles"] = "Seguir Ângulos de Impacto",
        ["options.thirdperson.follax.Hit.angles.help"] = "Seguir os ângulos de impacto com a câmara em terceira pessoa.",
        ["options.thirdperson.follax.Hit.fov"] = "Seguir FOV de Impacto",
        ["options.thirdperson.follax.Hit.fov.help"] = "Seguir o campo de visão (FOV) de impacto com a câmara em terceira pessoa.",
    ...
    ax.localisation:Register("bg", {
        ...
        ["options.thirdperson.follax.Head"] = "Следване на главата",
        ["options.thirdperson.follax.Head.help"] = "Следва ли изгледът от трето лице главата на играча.",
        ["options.thirdperson.follax.Hit.angles"] = "Следване на ъглите на удара",
        ["options.thirdperson.follax.Hit.angles.help"] = "Следва ли изгледът от трето лице ъглите на удара на играча.",
        ["options.thirdperson.follax.Hit.fov"] = "Следване на FOV на удара",
        ["options.thirdperson.follax.Hit.fov.help"] = "Следва ли изгледът от трето лице FOV на удара на играча.",
